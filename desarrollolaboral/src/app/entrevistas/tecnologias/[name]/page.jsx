    ...
    (<section className="w-full py-12 md:py-24 lg:py-32">
      ...
      <div className="container px-4 md:px-6">
        <div className="text-center mb-8 flex justify-between">
          ...
          <Link href="/entrevistas/tecnologias"><button type="button" className="w-full flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-700">
